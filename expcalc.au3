...
;					2) How long will it take non stop playing or if you play specific hours a day
...
Global $GUI_NAME = "Ragnarok X | EXP Calculator | by: Raff"

#Region ### START Koda GUI section ### Form=
$Form1 = GUICreate($GUI_NAME, 371, 187, 406, 324)
$Button1 = GUICtrlCreateButton("Load Sample Data", 264, 117, 99, 20, 0)
$Button2 = GUICtrlCreateButton("Exp/Hour", 288, 145, 75, 19, 0)

$Label1 = GUICtrlCreateLabel("Current EXP:", 4, 15, 96, 17)
$Label2 = GUICtrlCreateLabel("EXP Needed:", 4, 40, 87, 17)

$Label4_1 = GUICtrlCreateLabel("EXP Per Mob:", 4, 75, 92, 17)
$Label3 = GUICtrlCreateLabel("Grind Time (Hrs):", 4, 139, 79, 17)

$Label7_1 = GUICtrlCreateLabel("Mobs To Kill", 207, 15, 74, 17)
$Label7_2 = GUICtrlCreateLabel("0", 290, 15, 74, 17)
$Label8_1 = GUICtrlCreateLabel("Exp To Level:", 207, 40, 67, 17)
...
$Input4_mons_to_kill = GUICtrlCreateInput("", 101, 72, 49, 21)
...
AdlibRegister("_perform_exp_calc",600)
...
While 1
	...
	Switch $nMsg
		...
		Case $Button1
			GUICtrlSetData($Input1_exp_current,'906768')
			GUICtrlSetData($Input2_exp_need,'16700000')
			GUICtrlSetData($Input3_playing_hours,'24')
			GUICtrlSetData($Input4_mons_to_kill,'83')
			GUICtrlSetData($Input5_mobkilltime_sec,'1')
EndSwitch
WEnd

Func _perform_exp_calc()
...
;~ 	------------------------------------------------------------
	...
	$mons_to_kill = GUICtrlRead($Input4_mons_to_kill)

	$Mobs_to_kill	= $exp_needed_to_level / $mons_to_kill
...
;~ 	------------------------------------------------------------
	...
	GUICtrlSetData($Label8_2,$exp_needed_to_level)
